...
public class MUUnitInfo extends Object implements Comparable {
    ...
    public static final int		oldThreshold = 3;
    ...
    MUSection			armor[] = new MUSection[TOTAL_SECTIONS];
    ...
    //static ArrayList	icons[] = new ArrayList[TOTAL_MOVETYPES];

    static MUWeapon		weapons[] = new MUWeapon[200];		// data that stores info on /all/ weapons ... assume 200 of them for now
    ...
    /**
      ...
      */
    static Color colorForPercent(float p)
    {
        if (p >= 99)
