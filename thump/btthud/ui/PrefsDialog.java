...
public class PrefsDialog extends javax.swing.JDialog {
    ...
    private MPrefs     				prefs = null;
    private Thump					thudClass = null;
    ...
    private javax.swing.JButton 		bTerrainColors[] = new javax.swing.JButton[MUXHex.TOTAL_TERRAIN];
    ...
    public PrefsDialog(java.awt.Frame parent, boolean modal) {
        ...
        try {
            this.prefs = (MPrefs) ObjectCloner.deepCopy(thudClass.prefs);
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        for (int i = 0; i < MUXHex.TOTAL_TERRAIN; i++)
        {
            bTerrainColors[i].setText(MUXHex.terrainForId(i) + " " + MUXHex.nameForId(i));
    ...
    private void bTerrainColorActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        int whichTerrain = MUXHex.idForTerrain(st.nextToken().charAt(0));
